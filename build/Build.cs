...
#pragma warning restore CS0649
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests — no helm CLI required (we test argv shape, not behaviour).")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.Helm.V3.Tests" / "Tamp.Helm.V3.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.Helm.V3" / "Tamp.Helm.V3.csproj");
